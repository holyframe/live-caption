...
set "LIBS=user32.lib gdi32.lib comctl32.lib d2d1.lib dwrite.lib ole32.lib oleaut32.lib uuid.lib dwmapi.lib shlwapi.lib uxtheme.lib advapi32.lib shell32.lib"
